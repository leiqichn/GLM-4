...
# 指定原始文件路径和输出文件路径
input_path = "/chatGLM4/glm4-Toolkit/demo/process/fine-tuning/data_3.txt"  # 这里替换成你的输入文件路径
output_path = "/chatGLM4/glm4-Toolkit/demo/finetune_demo/data/train.jsonl"  # 这里替换成你的输出文件路径
