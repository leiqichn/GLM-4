...
if __name__ == "__main__":
    train_json_path = "/chatGLM4/glm4-Toolkit/demo/finetune_demo/data/train.jsonl"  # 训练集文件路径
    dev_json_path = "/chatGLM4/glm4-Toolkit/demo/finetune_demo/data/dev.jsonl"  # 保存开发集的目标文件路径
